...
def get_R_backward_argmax(X, R_minus_f, y, ni, C):
...
def get_parallel_backward_argmax(X, y, n_workers, alpha=0.05, beta=0.01):
...
if __name__ == '__main__':
    ...
    a = get_parallel_backward_argmax(X, y, n_workers = 5, alpha = 0.05, beta = 0.01)
    print(a)
